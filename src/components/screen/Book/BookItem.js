...
const BookItem = ({...props}) => {
    // const book = props.books.map((book, index) => (
        // <View key={index} style={{ flex: 1, flexDirection: 'row', marginBottom: 10, borderBottomWidth:1, borderBottomColor: "rgba(0,0,0,.1)", height: 110 }}>
        ...
        //         <Text style={{ fontSize: 18, marginLeft: 10, marginBottom: 5 }}>{book.name}</Text>
        //         <Text style={{ fontSize: 13, marginLeft: 10, marginBottom: 8 }}>{book.writer}</Text>
        //         <Text style={{ fontSize: 15, marginLeft: 10, marginBottom: 10 }}>Stock {book.stock}</Text>
        //     </View>
        // </View>
    // ))
